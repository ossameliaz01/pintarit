<x-sidebar-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- Card 1 -->
        <div class="bg-white border border-gray-100 p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
            ...
            <div class="text-3xl font-extrabold text-gray-800 mb-4">75%</div>
        ...
        <div class="bg-white border border-gray-100 p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
            ...
            <div class="text-lg font-bold text-gray-800 mb-4 leading-tight">Jaringan Dasar TKJ</div>
            <div class="w-full bg-gray-100 rounded-full h-1.5">
        ...
        <div class="bg-white border border-gray-100 p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
            ...
            <div class="text-3xl font-extrabold text-gray-800 mb-4">10/54</div>
            <div class="w-full bg-gray-100 rounded-full h-1.5">
        ...
        <div class="bg-white border border-gray-100 p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
            ...
            <div class="text-3xl font-extrabold text-gray-800 mb-4">4/5</div>
            <div class="w-full bg-gray-100 rounded-full h-1.5">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <!-- Lanjutkan Belajar -->
        <div>
            <h3 class="text-lg font-bold text-gray-800 mb-4">Lanjutkan Belajar</h3>
            <div class="bg-white border border-gray-100 p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex flex-col justify-between h-[200px]">
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1 w-full">
                        <h4 class="text-xl font-bold text-gray-800 mb-1">Dasar Jaringan</h4>
                ...
                <div class="flex justify-end mt-4">
                    <button class="bg-[#6c5ce7] hover:bg-[#5b4bc4] text-white font-semibold py-2 px-8 rounded-lg transition duration-200 shadow-md">
                        Lanjutkan
                    </button>
                </div>
            </div>
        ...
        <!-- Rekomendasi Materi -->
        <div>
            <h3 class="text-lg font-bold text-gray-800 mb-4">Rekomendasi Materi Untukmu</h3>
            <div class="space-y-4">
                <!-- Item 1 -->
                <div class="bg-white border border-gray-100 p-4 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex items-center justify-between hover:border-indigo-200 transition cursor-pointer">
                    <div class="flex items-center space-x-4">
                        <div class="w-14 h-14 bg-yellow-400 rounded-xl flex items-center justify-center text-white flex-shrink-0 shadow-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                            </svg>
                        </div>
                        <div>
                            <h4 class="text-lg font-bold text-gray-800">Ip Address Dasar</h4>
                            <p class="text-sm font-medium text-gray-400">Video - 30 menit</p>
                        </div>
                    </div>
                ...
                <div class="bg-white border border-gray-100 p-4 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex items-center justify-between hover:border-indigo-200 transition cursor-pointer">
                    <div class="flex items-center space-x-4">
                        <div class="w-14 h-14 bg-orange-400 rounded-xl flex items-center justify-center text-white flex-shrink-0 shadow-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                            </svg>
                        </div>
                        <div>
                            <h4 class="text-lg font-bold text-gray-800">OSI Model</h4>
                            <p class="text-sm font-medium text-gray-400">Video - 30 menit</p>
                        </div>
                    </div>
                    <div class="text-gray-300">
    ...
    <!-- Chart Section -->
    <div>
        <h3 class="text-lg font-bold text-gray-800 mb-4">Ringkasan Progress</h3>
        <div class="bg-white border border-gray-100 p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] w-full">
