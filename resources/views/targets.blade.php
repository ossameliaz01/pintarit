<x-sidebar-layout>
    <!-- Alpine Wrapper for toggling states -->
    <div x-data="{ state: 'active' }">
        ...
        <div class="mb-8 flex justify-between items-end">
            ...
            <div class="flex items-center space-x-2 bg-gray-100 p-1 rounded-lg">
                <button @click="state = 'active'" :class="state === 'active' ? 'bg-white shadow-sm text-gray-800' : 'text-gray-500'" class="px-3 py-1.5 rounded-md text-sm font-bold transition">Target Aktif</button>
                <button @click="state = 'empty'" :class="state === 'empty' ? 'bg-white shadow-sm text-gray-800' : 'text-gray-500'" class="px-3 py-1.5 rounded-md text-sm font-bold transition">Empty State</button>
            </div>
        </div>
