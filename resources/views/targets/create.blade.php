<x-sidebar-layout>
    ...
    <!-- Back Button -->
    <div class="mb-8">
        <a href="{{ route('target') }}" class="inline-flex items-center px-4 py-2 bg-[#f3f4fa] hover:bg-[#e4e5f1] text-[#3f317b] text-sm font-bold rounded-lg transition">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl p-8 max-w-3xl shadow-sm">
        <form>
            ...
            <div class="mb-6">
                ...
                <input type="text" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-gray-700 focus:outline-none focus:border-[#6c5ce7] focus:ring-1 focus:ring-[#6c5ce7] transition" placeholder="Contoh : 3" value="3">
            ...
            <!-- Submit Button -->
            <div>
                <button type="button" class="w-full bg-[#6c5ce7] hover:bg-[#5b4bc4] text-white font-bold py-3.5 px-4 rounded-xl transition shadow-sm">
                    Simpan Target
                </button>
            </div>
        </form>
