  ...
  return (
    <header className="h-16 flex items-center justify-between px-4 sm:px-6 flex-shrink-0"
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg sm:text-xl font-bold" style={{ color: '#372466' }}>{title}</h1>
      </div>
      <div className="flex items-center gap-2 sm:gap-3">
        {/* Search */}
        <div className="relative hidden sm:block">
          <Search size={18} className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: '#969696' }} />
          <input
        ...
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl"
          ...
          <span className="text-sm font-bold" style={{ color: '#333333' }}>+340</span>
          <span className="text-sm" style={{ color: '#969696' }}>XP hari ini</span>
        </div>
        ...
        >
          ...
          <div className="absolute -top-1 -right-1 w-5 h-5 rounded-full flex items-center justify-center text-sm text-white font-bold"
        ...
        <button
          ...
          className="w-11 h-11 rounded-xl flex items-center justify-center text-sm font-bold text-white transition-all duration-200"
